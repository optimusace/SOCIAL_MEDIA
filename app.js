...
app.post(
  '/api/v1/users/basic',
  upload.single('photo'),
  BasicInfoController.addUser
);
app.put(
  '/api/v1/users/basic/:id',
  upload.single('photo'),
  BasicInfoController.updateUser
);
...
app.get('/api/v1/comment/:userId', CommentController.getallCommentsOfUser);

app.get('/api/v1/comment/:postId', CommentController.getSpecificComments);

app.post('/api/v1/comment/:userId/:postId', CommentController.createComment);

app.put('/api/v1/comment/:id/:userId/:postId', CommentController.updateComment);

app.delete('/api/v1/comment/:id/:userId', CommentController.deleteComment);
